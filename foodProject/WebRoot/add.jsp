...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="<%=basePath%>css/mains.css">
	 <base href="<%=basePath%>">
    <meta charset="utf-8"/>
    <title>二手书商城</title>
    <!--头部适配-->
  ...
  <body>
   <div id="seilBook">
    ...
    <div class="seilBook-head">
     ...
     <main class="seilBook-form">
	    <div class="row">
		   
		      <s:form action="book/book_insert" cssClass="form-horizontal" enctype="multipart/form-data">
		      <div class="box-input">
